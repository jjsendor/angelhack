...
public class ToursController {
    ...
    public List<Tour> tours() {
        ...
        tours.add(new Tour(5, "Liverpool Street Mayhem Experience", "One of most panoramic walks in London! As we walk along the North Bank, you will see the iconic landmarks like OXO Tower, Tate Modern and Shakespeare's Globe theatre as well the Wobbly Bridge!!! Following the river path, you will find out about the history of River Thames, how it influenced development of the City over the centuries and discover why Thames has been the lifeblood of London for nearly 2000 years.", "http://snap-photos.s3.amazonaws.com/img-thumbs/960w/7E71222234.jpg", 30, 5000, new Date(new Date().getTime() + 18000), anna));
